                            ...
                            @foreach ($arsip as $a)
                                <div class="d-flex justify-content-between">
                                    <div class="col-sm-7 card-title mb-4">
                                        <strong><a href="{{ route('arsip.show', $a->id) }}"
                                                class="text-dark">{{ $a->judul }}</a></strong>
                                    </div>
                                    <div class="col-sm-2">
                                        <span>Oleh:</span>
                        ...
                        <div class="card-body">
                            ...
                            <div class="direct-chat-messages">
                                ...
                                <div class="direct-chat-msg">
                                    ...
                                    <!-- /.direct-chat-infos -->
                                    <img class="direct-chat-img" src="{{ asset('assets/dist/img/user1-128x128.jpg') }}s"
                                        alt="message user image">
                                    <!-- /.direct-chat-img -->
                                    <div class="direct-chat-text">
                                ...
                                <div class="direct-chat-msg right">
                                    ...
                                    <!-- /.direct-chat-infos -->
                                    <img class="direct-chat-img" src="{{ asset('assets/dist/img/user3-128x128.jpg') }}s"
                                        alt="message user image">
                                    <!-- /.direct-chat-img -->
                                    <div class="direct-chat-text">
                                        I would love to.
                            ...
                            <div class="direct-chat-contacts">
                                <ul class="contacts-list">
                                    ...
                                    <li>
                                        <a href="#">
                                            <img class="contacts-list-img"
                                                src="{{ asset('assets/dist/img/user3-128x128.jpg') }}s"
                                                alt="User Avatar">
